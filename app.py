...
<div class="card">
    ...
    <p>
    Là một thực tập sinh, tôi có khả năng giao tiếp tốt và thích ứng
    với mỗi môi trường làm việc.
    </p>
    ...
    biết cách phối hợp và hỗ trợ đồng nghiệp để hoàn thành các nhiệm
    vụ chung. Tôi luôn lắng nghe, trao đổi ý kiến và đảm bảo hiệu quả
    công việc trong môi trường hợp tác.
    </p>
