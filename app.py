...
<div class="card"> 
    ...
    <p> 
    Tôi có kiến thức cơ bản về Tin học văn phòng, có thể soạn thảo văn bản
    và sử dụng các phần mềm cơ bản trong tài chính. Mặc dù còn mới mẻ trong
    việc sử dụng các công cụ này, tôi luôn sẵn sàng học hỏi và cải thiện kỹ
    năng của mình để làm việc hiệu quả hơn.
    </p> 
</div> 
""", unsafe_allow_html=True) 
...
<div class="card"> 
    ...
    <p> 
    Là một thực tập sinh, tôi có khả năng giao tiếp tốt, thích ứng với
    mỗi môi trường làm việc.
    </p> 
</div> 
""", unsafe_allow_html=True) 
...
<div class="card"> 
    ...
    <p> 
    Là thực tập sinh ngân hàng, tôi có khả năng làm việc nhóm tốt, biết
    cách phối hợp và hỗ trợ đồng nghiệp để hoàn thành các nhiệm vụ chung.
    Tôi luôn lắng nghe, trao đổi ý kiến và đảm bảo hiệu quả công việc
...
st.markdown(
""" <center> <p>© CV Nguyễn Thị Thu Tuyền | Streamlit Portfolio</p> </center>
""",
unsafe_allow_html=True
)
